...
@save "examples/Transverse Ising/data/ψ_$(Lx)x$(Ly)_D_MPS=$(D_MPS)_J=$(J)_h=$(h).jld2" ψ
@save "examples/Transverse Ising/data/lsE_$(Lx)x$(Ly)_D_MPS=$(D_MPS)_J=$(J)_h=$(h).jld2" lsE
@save "examples/Transverse Ising/data/ObsDict_$(Lx)x$(Ly)_D_MPS=$(D_MPS)_J=$(J)_h=$(h).jld2" ObsDict
